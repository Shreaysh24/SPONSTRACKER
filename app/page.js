...
export default function Home() {
  ...
  return (
    <div>
      <Header />
      <div className="min-h-screen mt-12 bg-gradient-to-br from-[#c7badd] to-[#F5F5F5] px-6 py-10">
        {/* Hero Section */}
        <section className="max-w-6xl mx-auto mb-16 flex flex-col md:flex-row items-center relative">
          {/* Mobile BG Image */}
          ...
          <div className="flex-1 z-10 relative">
            ...
            <p className="text-xl text-[#3a2d4d] mb-8 font-extrabold">
              Empowering organizations to manage, promote, and track their
              events with ease. From conferences to workshops, SponsTracker
              helps you create memorable experiences and connect with your
              audience. Join us and make your next event a success!
            </p>
            <a
              href="#events"
              className="inline-block bg-gradient-to-r from-[#7c4dff] to-[#9575cd] text-white font-bold py-3 px-8 rounded-2xl shadow-xl hover:from-[#6a3fd8] hover:to-[#7e57c2] transition-all duration-300 text-lg"
            >
              Get Started
            </a>
          </div>
        ...
        <div id="events" className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="md:w-1/2 p-8 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-[#fff] text-base italic mb-6">
                      {e.description}
                    </p>
          ...
          {loading ? (
            <p className="text-center text-[#364F6B] font-medium animate-pulse">
              Loading...
            </p>
          ) : (
        ...
        {/* Big Event Section */}
<section className="w-full py-16 mt-0 relative overflow-hidden">
  ...
  <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10 px-4 relative z-10">
    {/* Desktop side image */}
    ...
    <div className="flex-1">
      <h2 className="text-4xl font-bold text-[#2d253a] mb-4">
        Annual Tech Summit 2023
      </h2>
      <p className="text-lg text-[#3a2d4d] mb-6">
        SponsTracker powered the Annual Tech Summit, bringing together 2,000+
        attendees, 50+ speakers, and 30+ sponsors for a day of innovation and
        networking. Our platform ensured seamless registration, real-time
        updates, and a memorable experience for all.
      </p>
      <div className="flex gap-8 text-[#7c4dff] font-bold text-xl flex-wrap">
        <div>
          ...
          <div className="max-w-3xl mx-auto text-center px-4">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M7 17a4 4 0 01-4-4V7a4 4 0 014-4h3a4 4 0 014 4v6a4 4 0 01-4 4H7zm10 0a4 4 0 01-4-4V7a4 4 0 014-4h3a4 4 0 014 4v6a4 4 0 01-4 4h-3z"
              />
            </svg>
            <p className="text-2xl md:text-3xl text-white font-semibold mb-6 italic">
              &quot;SponsTracker made our event a breeze! The platform was
              intuitive, the support was fantastic, and our attendees loved the
              experience. Highly recommended for any organization looking to
            ...
            <div className="flex flex-col items-center gap-2">
              <Image
                ...
                width={56}
                height={56}
                className="rounded-full border-4 border-[#7c4dff]"
              />
              <span className="text-lg text-white font-bold">Priya Sharma</span>
              <span className="text-[#bdbdbd]">
                Event Manager, Tech Summit
              </span>
            </div>
          </div>
        </section>
