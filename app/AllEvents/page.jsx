...
const AllEvents = () => {
  ...
  const fetchEvents = async (limit = 10) => {
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 404) console.log("No events found");
  ...
  return (
    <div>
      <div id="events" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 mb-10">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-left text-[#364F6B] mb-12 tracking-wide drop-shadow-md">
          Upcoming Events
        </h1>
        ...
        <div className="flex flex-col gap-10">
          {events.map((e) => (
            ...
            >
              {/* Media Section */}
              <div className="w-full md:w-1/2 aspect-video bg-[#3FC1C9] flex items-center justify-center">
              ...
              <div className="w-full md:w-1/2 p-6 sm:p-8 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-[#fff] text-sm sm:text-base italic mb-6">
                    {e.description}
                  </p>
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    className="w-full sm:w-auto bg-gradient-to-r from-[#7c4dff] to-[#9575cd] text-white font-bold py-2 px-6 rounded-xl shadow-lg hover:from-[#6a3fd8] hover:to-[#7e57c2] transition text-lg"
